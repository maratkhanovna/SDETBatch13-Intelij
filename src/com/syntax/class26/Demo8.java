...
public class Demo8 {
    public static void main(String[] args) {
        ...
        ArrayList<String> allSubjects2 = new ArrayList<>();//shift+end will select part of line ctrl+c to select complete line
        allSubjects2.addAll(subjectsSeen);
        //insert the data starting from the index1 and will push the existing data towards the end
